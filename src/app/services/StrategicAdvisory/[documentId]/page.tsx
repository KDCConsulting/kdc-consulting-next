...
interface StrategicAdvisoryDetailPageProps {
    params: Promise<{
        documentId: string;
    }>;
}
...
export async function generateStaticParams(): Promise<{ documentId: string }[]> {
  // 返回一些静态参数，确保构建成功
  return [
    { documentId: 'strategic-1' },
    { documentId: 'strategic-2' },
    { documentId: 'strategic-3' }
  ];
}

export async function generateMetadata({
    params,
}: StrategicAdvisoryDetailPageProps): Promise<Metadata> {
    ...
    return {
        ...
        description:
            ...
            "科智咨询的专业服务详情页面。",
        keywords: `${service.channelName},战略咨询,科智咨询`,
        openGraph: {
            title: `${service.channelName}_科智咨询`,
            description:
                service.ServiceContentBriefIntroduction ||
...
export default async function StrategicAdvisoryDetailPage({
    params,
}: StrategicAdvisoryDetailPageProps) {
    // 获取特定服务数据
    const service = await getServiceByDocumentId(
        ServiceType.STRATEGIC,
        params.documentId
    ...
    // 获取所有战略咨询服务用于推荐阅读
    const allStrategicServices = await getServicesData(ServiceType.STRATEGIC);

    // 调试信息
    console.log("Strategic Advisory Detail Service Data:", service);
                                                            ...
                                                            {service.ServiceContentComponents && service.ServiceContentComponents.length > 0 ? (
                                                                ...
                                                                <>
                                                                    <div className="fuwu-flex-item">
                                                                        <h6>宏观环境分析</h6>
                                                                        <p>对企业所处的宏观环境进行全面分析，帮助把握外部环境的机遇与威胁。</p>
                                                                        <div className="after"></div>
                                                                    </div>
                                                                    <div className="fuwu-flex-item">
                                                                        <h6>行业环境与竞争格局分析</h6>
                                                                        <p>深入分析行业趋势、市场结构、竞争对手情况，明确企业的市场定位和发展空间。</p>
                                                                        <div className="after"></div>
                                                                    </div>
                                                                    <div className="fuwu-flex-item">
                                                                        <h6>内部资源和能力分析</h6>
                                                                        <p>评估企业的内部资源和能力，识别企业的核心竞争力和潜在增长点。</p>
                                                                        <div className="after"></div>
                                                                    </div>
                                                                </>
                                                            )}
                                                        ...
                                                        <div className="fuwu-flex">
                                                            {service.ServiceValuePropositionComponents && service.ServiceValuePropositionComponents.length > 0 ? (
                                                                ...
                                                                <>
                                                                    <div className="fuwu-flex-item">
                                                                        <h6>灵活应变与持续支持</h6>
                                                                        <p>科智始终保持与企业的紧密联系，随时准备根据最新情况调整规划，并提供持续性支持和指导。</p>
                                                                        <img
                                                                            src="https://www.kzconsulting.cn/resource/image/20240802/1004060921712082944.png"
                                                                            alt=""
                                                                        />
                                                                    ...
                                                                    <div className="fuwu-flex-item">
                                                                        <h6>跨领域整合</h6>
                                                                        <p>科智专家具备跨领域的知识和技能，为客户提供综合性战略规划服务。</p>
                                                                        <img
                                                                    ...
                                                                    <div className="fuwu-flex-item">
                                                                        <h6>创新推动</h6>
                                                                        <p>科智鼓励企业创新，帮助客户在产品、技术、管理等方面实现突破。</p>
                                                                        <img
                                                                ...
                                                                <div className="cmp-teaser__content">
                                                                    <h3 className="cmp-teaser__title">
                                                                        <a
                                                                            ...
                                                                            href={`/services/StrategicAdvisory/${relatedService.documentId}`}
                                                                            target="_self"
                                                                        >
